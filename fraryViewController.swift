...
class fraryViewController: UIViewController {
    
    var jsonData: AnyObject?
    
    @IBOutlet weak var fraryMenu: UITextView!


    override func viewDidLoad() {
        super.viewDidLoad()
        
        self.navigationItem.title = "Frary Menu"
