...
class muddViewController: UIViewController {
    
    var jsonData: AnyObject?
    
    @IBOutlet weak var muddMenu: UITextView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        self.navigationItem.title = "Harvey Mudd Menu"
